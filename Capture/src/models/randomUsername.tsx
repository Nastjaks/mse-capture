const randomNames: string[] = [
    "Fliegender Einhorn", "Tanzender Wurst", "Kochender Alpaka", "Schwimmender Pinguin",
    ...
    "Zitternder Zirkus", "Brennender Wal", "Hinterhältiger Wurm", "Sprechende Mütze",
    ...
    "Tanzende Tomate", "Laufender Pinguin", "Bitterer Apfel", "Fliegender Lachs",
